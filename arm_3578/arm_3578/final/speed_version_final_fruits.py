...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            if not self.phase_initialized:
                ...
                self.final_ferti_target[2] -=0.005
...
# -----------------------------------------------------------------------------------------------------------------------
            ...
            if self.move_to_tcp_target(self.reverse_target, tol=0.02, slow=False):
...
# --------------------------------------------------------------PHASE_ALIGN_TO_FERTI------------------------------------------------------
            ...
            if not self.phase_initialized:
                ...
                #  self.lift_target[1]  -= 0.03     #<------------------ try this one remove the hore ones 
                 self.phase_initialized = True
                 self.get_logger().info(f"Lifting to: {self.lift_target}")
...
# ========================================================new return mrthod ==================================================
        ...
        elif self.phase == 'RETURN_TRAY_POSE_NEXT_UNLOAD':
            # 1. Calculate the remaining distance for each axis
