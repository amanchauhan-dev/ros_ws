...
# -----------------------------------------------------------------------------------------------------------------------------------------
            ...
            if self.wait_for_timer(1.0):
                ...
                self.phase = 'SAFE_HOVER_POSE'   # <======  here i chnage below if any collision then   change the phase 
...
# ----------------------------------------------------------------------------------------------------------------------------
        ...
        elif self.phase == 'SAFE_HOVER_POSE':   #<============ if any troble here 
            if not self.phase_initialized:
                 self.lift_target = self.current_tcp_pos.copy()
                 self.lift_target[1] -= 0.05
                 self.lift_target[2] += 0.20
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            if self.wait_for_timer(1.0):
                self.phase = 'RETURN_TRAY_POSE_FAST'



# ========================================================new return mrthod ==================================================

        elif self.phase == 'RETURN_TRAY_POSE_FAST':
