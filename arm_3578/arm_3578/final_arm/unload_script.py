...
# ----------------------------------------------------------------------------------------------------------------------------------------
            ...
            if self.move_to_tcp_target_v2(self.ferti_unload_target, tol_xy=0.001, tol_z=0.01, slow=False):
...
# ------------------------------------------------------------------------------------------------------
            ...
            if not self.phase_initialized:
                 ...
                 self.ferti_unload_target_final[0] -= 0.04
...
# ---------------------------------------------------------------------------------------------------------------------------------------
            ...
            # self.move_joint_to_angle(self.safe_lift_angle, self.joint_names_list[1], 1):
             ...
             if reached :
                ...
                self.get_logger().info("we are lift success fully ")
                self.phase_initialized = False
