...
# ------------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            reached = self.move_to_tcp_target(self.ebotApproach_target, tol=0.005, slow=True)
...
# ----------------------------------------------------------------------------------------------------------
            ...
            if not self.phase_initialized :
                ...
                self.target_dustbin[2] += 0.05
                self.get_logger().info("we are moving at the dustbin ")
                self.phase_initialized = True

            reached = self.move_to_tcp_target(self.target_dustbin, tol=0.02, slow=False)
            if reached:
...
# ----------------------------------------------------------------------------------------------------------------------------------------
            ...
            if self.move_to_tcp_target_v2(self.ferti_unload_target, tol=0.001, slow=False):
