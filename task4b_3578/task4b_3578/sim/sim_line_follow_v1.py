...
# LINES = [
#     ((-1.5, -5.6), (0.32, -5.6)), # 1
#     ((0.32, -5.6), (0.32,  1.38)), # 2
#     ((0.32,  1.38), (-1.5, 1.38)), # 3
#     ((-1.5, 1.38), (-1.5, -5.6)), # 4
#     ((-1.5, -5.6), (-3.459, -5.6)), # 5
#     ((-3.459, -5.6), (-3.459, 1.38)), # 6
#     ((-3.459, 1.38), (-1.5, 1.38)), # 7
#     ((-1.5, 1.38), (-1.5, -5.6)) # initial
# ]
    ...
    try:
        while rclpy.ok():
            ...
            if node.state != node.DONE:
                ...
                ax.plot([a[0],b[0]],[a[1],b[1]],'g-',lw=4)
            ...
            if node.lidar_pts:
                x, y = np.vstack(node.lidar_pts).T
                ax.scatter(x, y, c='orange', s=5)
