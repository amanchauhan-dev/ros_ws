...
def euler_to_quaternion(roll, pitch, yaw):
    ...
    Needed because the new interface gives Euler, but your logic uses Quaternions.
    """
...
class Task4c(Node):
    def __init__(self):
        ...
        self.approachSideOffsetYmeters = 0.03
       ...
       # --- FERTILIZER SERVO PARAMETERS ---
        self.fertilizerMaximumLinearVelocity = 1.1
        self.fertilizerMaximumAngularVelocity = 3.2
        self.fertilizerPositionTolerance = 0.01
        self.fertilizerAngularToleranceRadians = np.radians(10.0)
        ...
        self.fruitApproachOffsetZmeters = 0.06
        ...
        self.fruitMaximumAngularVelocity = 3.8
...
# --------------------------------------------------------------------------
    def tcp_pose_callback(self, msg):
        ...
        if len(msg.data) >= 6:
            ...
            # The script logic relies on quaternions, so we must convert.
            roll = msg.data[3]
            pitch = msg.data[4]
            yaw = msg.data[5]
...
# --------------------------------------------------------------------------------------------------
            ...
            # This phase was skipped in the logic above, but kept here for structure
            self.phase = 'ATTACH_FERTI_ACTION'

        elif self.phase == 'ATTACH_FERTI_ACTION':
            # Use the new updated function logic
...
# =========================================================================
            ...
            if reached_orientation:
                self.get_logger().info("Wrist is set. Settling.")
                self.halt_motion()
